    ...
    <div class="preheader">
      <div class="wrapper">
        ...
        <div class="preheader__stars">
          ...
          <Stars :inValue="$store.state.filters.stars"> </Stars>
        </div>
    ...
    <div class="main-info">
      <div class="wrapper">
        <div class="main-info__count gray-text">
          Показано {{places.length}} из {{this.$store.state.places.length}} <span>(очистить фильтры)</span>
        </div>
        <div class="main-page">
          ...
          <div class="main-page__places" v-if="places" >
            <div class="main-page__place m-place"
              ...
              <div class="m-place__hidden" v-if="!place.editing">
                <span @click="editActive(place)">
              ...
              <div class="edit-save" v-if="place.editing" @click="editSave(place)">Сохранить</div>
              ...
              <input class="edit-input" type="text" v-model="editPlace.averageCheck" v-if="place.editing">

              <div v-if="!place.editing" class="m-place__address">
                <div class="gray-text">{{place.category.name}},</div>
                {{place.address}}
              </div>
              <input class="edit-input" type="text" v-model="editPlace.address" v-if="place.editing">
            </div>
          </div>
        </div>
      </div>
